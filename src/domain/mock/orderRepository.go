...
func (m *MockOrderRepository) Confirm(ctx context.Context, id int64) error {
	m.ctrl.T.Helper()
...
func (mr *MockOrderRepositoryMockRecorder) Confirm(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Confirm", reflect.TypeOf((*MockOrderRepository)(nil).Confirm), ctx, id)
}
...
func (m *MockOrderRepository) Delivered(ctx context.Context, id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delivered", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delivered indicates an expected call of Delivered.
func (mr *MockOrderRepositoryMockRecorder) Delivered(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delivered", reflect.TypeOf((*MockOrderRepository)(nil).Delivered), ctx, id)
}
